...
public class Tank : MonoBehaviour
{
    ...
    public void Kill()
    {
        ...
        d.GetComponent<SpriteRenderer>().sprite = Resources.Load<Sprite>(MapLoader.Instance.icons["death"]);
        Instantiate(d, this.transform.position, Quaternion.Euler(0,0,45));
